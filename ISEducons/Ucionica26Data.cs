...
{
    [Serializable]
    public class Ucionica26Data : INotifyPropertyChanged
    {
        string id;
        string cpu;
        string gpu;
        ...
        public Ucionica26Data(string Id, string Cpu, string Gpu, string Ram, string Mobo, string Psu, string Monitor, string Mis, string Tastatura, string Komentar)
        {
            this.Id = Id;
            this.Cpu = Cpu;
            this.Gpu = Gpu;
